...
class Program:
    ...
    def exec(self, op, mode, start_pos):
        ...
        result, jump = astuple(OpResult(op.func(*inputs)))
        if op.output_count:
            self.program[self.program[start_pos + 1 + op.input_count]] = result
        else:
            print(result)
        return jump
    ...
    def run(self, input_):
        ...
        while True:
            ...
            i = jump or i + 1 + op.input_count + op.output_count
